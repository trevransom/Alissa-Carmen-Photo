	...
	<div id="page-wrap">
		<div class="gallery_body">
			<div id="gallery_body">
				...
				<p>Meet Austin Champion! Austin recently graduated from Biola University with a degree in International Business. Austin 
					hopes to work internationally with a humanitarian relief organization in the fall! Congratulations Austin!</p>
				</div>
