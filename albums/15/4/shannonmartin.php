	...
	<div id="page-wrap">
		<div class="gallery_body">
			<div id="gallery_body">
				...
				<p>I've known Shannon since we were freshmen in college! This girl has a love for life and a joyful 
				spirit that is evident to all. Congratulations on graduating college Shan, much happiness to you in 
				the years to come!</p>
				</div>
